...
import 'package:flutter_wordpress_api_get_post/services/art/artCelebrity.dart';
...
class ArtCelebrity extends StatefulWidget {

  ArtCelebrity({Key? key}) : super(key: key);

  @override
  _ArtCelebrityState createState() => _ArtCelebrityState();
}

class _ArtCelebrityState extends State<ArtCelebrity> {
  ArtCelebrityApi postService = ArtCelebrityApi();
