...
import 'package:flutter_wordpress_api_get_post/services/art/celebrityNews.dart';
...
class CelebrityNews extends StatefulWidget {

  CelebrityNews({Key? key}) : super(key: key);

  @override
  _CelebrityNewsState createState() => _CelebrityNewsState();
}

class _CelebrityNewsState extends State<CelebrityNews> {
  CelebrityNewsyApi postService = CelebrityNewsyApi();
