...
import 'package:flutter_wordpress_api_get_post/services/art/worldCelibrities.dart';
...
class WorldCelebrities extends StatefulWidget {

  WorldCelebrities({Key? key}) : super(key: key);

  @override
  _WorldCelebritiesState createState() => _WorldCelebritiesState();
}

class _WorldCelebritiesState extends State<WorldCelebrities> {
  WorldCelebritiesApi postService = WorldCelebritiesApi();
