...
import 'package:flutter_wordpress_api_get_post/services/fashion/forMan.dart';
...
class ForMan extends StatefulWidget {
  ...
  ForMan({Key? key}) : super(key: key);

  @override
  _ForManState createState() => _ForManState();
}

class _ForManState extends State<ForMan> {
  ForManApi postService = ForManApi();
