...
import 'package:flutter_wordpress_api_get_post/services/health/healthFitness.dart';
...
class HealthFitness extends StatefulWidget {
  ...
  HealthFitness({Key? key}) : super(key: key);

  @override
  _HealthFitnessState createState() => _HealthFitnessState();
}

class _HealthFitnessState extends State<HealthFitness> {
  HealthFitnessApi postService = HealthFitnessApi();
