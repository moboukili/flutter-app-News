...
import 'package:flutter_wordpress_api_get_post/services/health/publicHealth.dart';
...
class PublicHealth extends StatefulWidget {

  PublicHealth({Key? key}) : super(key: key);

  @override
  _PublicHealthState createState() => _PublicHealthState();
}

class _PublicHealthState extends State<PublicHealth> {
  PublicHealthApi postService = PublicHealthApi();
