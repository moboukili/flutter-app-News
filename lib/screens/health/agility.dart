...
import 'package:flutter_wordpress_api_get_post/services/health/agility.dart';
...
class Agility extends StatefulWidget {

  Agility({Key? key}) : super(key: key);

  @override
  _AgilityState createState() => _AgilityState();
}

class _AgilityState extends State<Agility> {
  AgilityApi postService = AgilityApi();
