...
import 'package:flutter_wordpress_api_get_post/services/family/maritalRelationships.dart';
...
class MaritalRelationships extends StatefulWidget {

  MaritalRelationships({Key? key}) : super(key: key);

  @override
  _MaritalRelationshipsState createState() => _MaritalRelationshipsState();
}

class _MaritalRelationshipsState extends State<MaritalRelationships> {
  MaritalRelationshipsApi postService = MaritalRelationshipsApi();
