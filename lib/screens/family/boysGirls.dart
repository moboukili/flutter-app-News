...
import 'package:flutter_wordpress_api_get_post/services/family/boysGirls.dart';
...
class BoysGirls extends StatefulWidget {

  BoysGirls({Key? key}) : super(key: key);

  @override
  _BoysGirlsState createState() => _BoysGirlsState();
}

class _BoysGirlsState extends State<BoysGirls> {
  BoysGirlsApi postService = BoysGirlsApi();
