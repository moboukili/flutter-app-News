...
import 'package:flutter_wordpress_api_get_post/services/family/familySociety.dart';
...
class FamilySociety extends StatefulWidget {

  FamilySociety({Key? key}) : super(key: key);

  @override
  _FamilySocietyState createState() => _FamilySocietyState();
}

class _FamilySocietyState extends State<FamilySociety> {
  FamilySocietyApi postService = FamilySocietyApi();
